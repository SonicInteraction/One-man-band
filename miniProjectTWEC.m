...
[first, firstname, second, secondname] = WhichFiles(bass1,'Bass',Gtr,'Guitar');
...
clc;
close all;
[nblocks1, fft1, E1] = fftForTW2(first,win);
[nblocks2, fft2, E2] = fftForTW2(second,win);
